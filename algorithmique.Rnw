...
\autoref{chap:donnes}), mais leur réelle mise en œuvre demeure tout à
...
Je vous invite donc à étudier les chapitre suivants de \emph{Essential
Algorithms}:
\begin{itemize}
...
\item Le livre fait ici et là référence au concept de \emph{library}.
  ...
  programmes. Certains langages de programmation sont constitué d'un
...
\begin{exercice}
  Effectuer une mise en œuvre en R de l'algorithme
  ...
  \begin{sol}
    ...
    \begin{figure}
      \lstinputlisting[frame=single,numbers=none]{include/insertionsort.R}
...
\begin{exercice}
  ...
  \begin{sol}
    ...
    \autoref{fig:algorithmique:selecionsort} constitue une mise en
    œuvre de l'algorithme en R. Dans plusieurs langages de
...
\end{Verbatim}
    ...
    \begin{figure}
      \lstinputlisting[frame=single,numbers=none]{include/selectionsort.R}
...
@
    ...
    \autoref{fig:algorithmique:selecionsort}; voir la fonction de la
    \autoref{fig:algorithmique:selecionsort-which}.

    \begin{figure}
      \lstinputlisting[frame=single,numbers=none]{include/selectionsort-which.R}
      \caption{Mise en œuvre en R de l'algorithme \emph{selectionsort}
...
\begin{exercice}
  ...
  \begin{sol}
    ...
    \begin{figure}
      \lstinputlisting[frame=single,numbers=none]{include/bubblesort-while.R}
...
@
    ...
    \begin{figure}
      \lstinputlisting[frame=single,numbers=none]{include/bubblesort-repeat.R}
      \caption{Mise en œuvre en R de l'algorithme \emph{bubblesort}
...
\begin{exercice}
  ...
  \begin{sol}
    ...
    \begin{figure}
      \lstinputlisting[frame=single,numbers=none]{include/countingsort.R}
...
@
    ...
    utilise la fonction \icode{table} de R qui retourne justement le
...
\begin{exercice}
  Effectuer une mise en œuvre en R de l'algorithme \emph{linear search}.
  \begin{sol}
    ...
    \begin{figure}
      \lstinputlisting[frame=single,numbers=none]{include/linsearch.R}
      \caption{Mise en œuvre en R de l'algorithme
        \emph{linear search}}
...
\begin{exercice}
  Effectuer une mise en œuvre récursive en R de l'algorithme
  \emph{linear search}.
  \begin{sol}
    ...
    \begin{figure}
      \lstinputlisting[frame=single,numbers=none]{include/rlinsearch.R}
...
@
    ...
    \begin{figure}
      \lstinputlisting[frame=single,numbers=none]{include/rlinsearch-na.R}
      \caption{Mise en œuvre récursive en R de l'algorithme
...
\begin{exercice}
  Effectuer une mise en œuvre en R de l'algorithme \emph{binary search}.
  \begin{sol}
    ...
    \begin{figure}
      \lstinputlisting[frame=single,numbers=none]{include/binsearch.R}
      \caption{Mise en œuvre en R de l'algorithme
        \emph{binary search}}
...
\begin{exercice}
  ...
  \begin{sol}
    ...
    \begin{figure}
      \lstinputlisting[frame=single,numbers=none]{include/rbinsearch.R}
      \caption{Mise en œuvre récursive en R de l'algorithme
        \emph{binary search}}
...
\begin{exercice}
  Effectuer une mise en œuvre récursive en R de la fonction
  factorielle.
  \begin{sol}
...
\begin{exercice}
  Effectuer une mise en œuvre récursive en R de la suite de Fibonacci.
  \begin{sol}
