...
rank(c(4, -1, 2, 6))
@
\item[\href{http://youtu.be/order}{\Fonction{order}}]
  ordre\index{ordre}\capsule{http://youtu.be/order}{} d'extraction des
...
La %
\capsule{http://youtu.be/outer}{fonction \code{outer}}%
\Indexfonction{outer} %
