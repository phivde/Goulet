...
Les opérateurs de puissance (\verb|^|\index{\string^@\verb=^=}) et
d'assignation à gauche (\fonction{<-}, \verb|<<-|) sont évalués de
droite à gauche; tous les autres de gauche à droite. Ainsi,
\verb|2 ^ 2 ^ 3| est \verb|2 ^ 8|, et non \verb|4 ^ 3|, alors que
\verb|1 - 1 - 1| vaut \verb|-1|, et non \verb|1|.
