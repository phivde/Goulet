...
\item Lancer RStudio et ouvrir soit un nouveau fichier de script avec
  \begin{quote}
    \rstudio{Ctrl+Shift+N} $\bullet$ \rstudio{\shiftkey\,\cmdkey\,N}
  \end{quote}
  ou avec le menu
  \begin{quote}
  ...
  \begin{quote}
    \rstudio{Ctrl+O} $\bullet$ \rstudio{\cmdkey\,O}
  \end{quote}
  ou
  \begin{quote}
    \code{File|Open File...}
...
%% texte inutilisé mais conservé au cas où...
% \begin{enumerate}
% \item Créer d'abord un projet dans RStudio tel que décrit à la
%   \autoref{rstudio:projets}.
% \item Lancer l'application RStudio et ouvrir un projet avec la
%   commande \code{Open Project...} du menu \code{Project} à l'extrémité
%   droite de la barre d'outils ou à partir du menu
%   \begin{quote}
%     \code{File|Open Project...}
%   \end{quote}
%   L'ouverture du projet entraîne le démarrage d'un nouveau processus R
%   et l'ouverture des fichiers de script associés au projet lors de la
%   dernière séance de travail.
% \item Quitter RStudio avec la commande \code{Close Project}
%   du menu \code{Project} à l'extrémité droite de la barre d'outils ou
%   à partir du menu
%   \begin{quote}
%     \code{File|Close Project}
%   \end{quote}
%   RStudio se chargera de sauvegarder tous les fichiers de scripts
%   ouverts ainsi que le processus R [...]
% \end{enumerate}
