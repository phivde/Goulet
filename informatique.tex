...
logicielles d'un ordinateur. Premier logiciel exécuté par l'ordinateur
lors de la mise en marche, le système d'exploitation reçoit les
demandes de ressources des applications --- espace mémoire, unité de
calcul, disque dur, communication avec les périphériques,
...
connus aujourd'hui sont Microsoft Windows, macOS de Apple et Linux pour
les ordinateurs de table et les serveurs; Android et iOS pour les
appareils mobiles.
