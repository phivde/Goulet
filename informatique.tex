...
\osxbox{Dans le Finder, le \index{repertoire personnel@répertoire
    personnel}répertoire personnel, ou \emph{home directory} en
  anglais, est représenté par\dots\ une maison.}
...
\importantbox{Le répertoire personnel n'est pas affiché par défaut
  dans l'Explorateur Windows. Pour y accéder, ouvrir l'arborescence
  «Ce PC» ou «Ordinateur».}
