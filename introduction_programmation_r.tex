\documentclass[letterpaper,11pt]{memoir}
  ...
  \title{%
    \bfseries\fontsize{42}{42}\selectfont Introduction à la \\
                                          programmation en R}
  \author{%
    \mdseries\fontsize{24}{24}\selectfont Vincent Goulet \\
    \mdseries\fontsize{16}{24}\selectfont École d'actuariat,
                                          Université Laval}
  \date{%
    \mdseries\fontsize{16}{18}\selectfont Troisième édition}
  \newcommand{\ISBN}{978-2-9811416-x-x}
...
\tableofcontents*
\enlargethispage{8mm}           % sinon ligne Index seule sur une page
