...
sous forme d'une fonction\footnote{%
  ...
  traitement donné porte différents noms selon le langage de
  programmation: routine, sous-routine, méthode, procédure,
  sous-procédure\dots}. %
...
est exécuté tant et aussi longtemps que \meta{condition} est vraie.
