...
\tipbox{C'est une erreur commune dans la rédaction d'un algorithme de
  ...
  langage de programmation donné. Lorsque vous écrirez un algorithme,
  demandez-vous si vous êtes en train d'expliquer comment mesurer une
  quantité de lait avec une tasse de marque ACME.}
