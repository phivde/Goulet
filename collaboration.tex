...
\index{CVS}\link{https://fr.wikipedia.org/wiki/Concurrent_versions_system}{\emph{Concurrent
    Versions System}} (CVS, 1990) a régné sur le monde de la gestion
de versions, jusqu'à l'arrivée de
\index{Subversion}\link{https://fr.wikipedia.org/wiki/Apache_Subversion}{\emph{Apache
...
sont \index{Git}\link{https://fr.wikipedia.org/wiki/Git}{\emph{Git}} (2005),
\index{Mercurial}\link{https://fr.wikipedia.org/wiki/Mercurial}{\emph{Mercurial}} (hg,
2005) et
\index{Bazaar}\link{https://fr.wikipedia.org/wiki/Bazaar_(logiciel)}{\emph{Bazaar}}
(bzr, 2005).
