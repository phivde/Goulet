...
\documentclass[letterpaper,11pt,x11names,english,french]{memoir}
  ...
  \colorlet{indexedface}{LightSkyBlue2}     % cellule indexée (face)
  \colorlet{indexedtop}{LightSkyBlue3}      % cellule indexée (dessus)
  \colorlet{indexedside}{LightSkyBlue4}     % cellule indexée (côté)
  \colorlet{mindexedface}{SkyBlue2} % cellule indexée médium (face)
  \colorlet{mindexedtop}{SkyBlue3}  % cellule indexée médium (dessus)
  \colorlet{mindexedside}{SkyBlue4} % cellule indexée médium (côté)
  \colorlet{dindexedface}{DeepSkyBlue2} % cellule indexée foncé (face)
  \colorlet{dindexedtop}{DeepSkyBlue3}  % cellule indexée foncé (dessus)
  \colorlet{dindexedside}{DeepSkyBlue4} % cellule indexée foncé (côté)
