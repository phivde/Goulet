...
\documentclass[letterpaper,11pt,x11names,english,french]{memoir}
  ...
  \colorlet{indexedface}{PaleGreen2}        % cellule indexée (2D et 3D)
  \colorlet{indexedtop}{PaleGreen3}         % cellule indexée (3D, dessus)
  \colorlet{indexedside}{PaleGreen4}        % cellule indexée (3D, côté)
  ...
  %% ci-dessous, causent problème lorsque le mot clé est suivi d'une
