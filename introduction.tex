...
Le code des sections d'exemples est distribué en version électronique
avec le document dans des fichiers de script. À chaque fichier
\code{.R} correspond un fichier \code{.Rout} contenant les résultats
de son évaluation non interactive.
...
\warningbox{Avertissement! Ces blocs mettent l'emphase sur une notion
