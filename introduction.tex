...
Le texte qui suit est la somme de notes et d'exercices de différents
cours donnés par l'auteur à l'École d'actuariat de l'Université Laval
depuis septembre 2003. Les six premiers chapitres, qui constituent le
...
(Windows) et 7.0 (Linux et Windows). Pour \textsf{R}, la version 2.3.1
...
C'est d'ailleurs pourquoi ce qui explique les nombreux renvois au
livre de \cite{MASS}, plus complet.
