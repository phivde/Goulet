...
% Ce chapitre est consacré à l'étude des \emph{expressions régulières} pour
% l'analyse et le contrôle de texte. Une expression régulière (\emph{regular
...
% une lettre, deux chiffres, une espace, trois lettres. Les lettres O, I
% et U ne sont pas utilisées à cause de leur similitude avec,
% respectivement, les chiffres 0 et 1 et la lettre V. L'expression
% régulière \verb=[A-HJ-NP-TV-Z][0-9]{2} [A-HJ-NP-TV-Z]{3}= permet de
% décrire l'ensemble des numéros de plaques possibles (y compris les
...
% programmation. Ce jour-là, connaitre les expressions régulières vous
% sauvera énormément de temps.


% * Lectures obligatoires

% Ce module n'est pas basé sur le document de référence, mais bien sur de la documentation disponible en ligne.

% Il existe une multitude de tutoriels et de documents de référence sur les expressions régulières et sur les utilitaires 'grep', 'sed' et 'awk' dans Internet. La référence que nous utiliserons dans le cours est le guide [Shell Scripting Primer](https://developer.apple.com/library/content/documentation/OpenSource/Conceptual/ShellScripting/) de la bibliothèque pour développeurs de Apple.

% > Utilisateurs de Windows: pas de souci! Bien qu'émanant de Apple, le guide traite d'outils Unix standards, outils que vous avez justement installé avec Git Bash au début de la session.

% Les chapitres du guide à lire sont les suivants:

% - Chapitre [Regular Expressions Unfettered](https://developer.apple.com/library/content/documentation/OpenSource/Conceptual/ShellScripting/RegularExpressionsUnfettered/RegularExpressionsUnfettered.html) jusqu'à la section [Using Modifiers](https://developer.apple.com/library/content/documentation/OpenSource/Conceptual/ShellScripting/RegularExpressionsUnfettered/RegularExpressionsUnfettered.html#//apple_ref/doc/uid/TP40004268-CH238-SW17), inclusivement.

% - Chapitre [How AWK-ward](https://developer.apple.com/library/content/documentation/OpenSource/Conceptual/ShellScripting/Howawk-ward/Howawk-ward.html) jusqu'à la section [Changing the Record and Field Separators in AWK Scripts](https://developer.apple.com/library/content/documentation/OpenSource/Conceptual/ShellScripting/Howawk-ward/Howawk-ward.html#//apple_ref/doc/uid/TP40004268-TP40003518-SW3), inclusivement.

% ! Aucune notion relative à Perl n'est au programme du cours.

% > Vous trouverez plusieurs ressources alternatives dans la section Activités complémentaires.


% \ lorsque commandes longues

% Un mot sur les opérateurs |, > et <.
