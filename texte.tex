...
\index{{"|}@\code{\textbar} (Bash)|bfhyperpage} «\code{\textbar}» permet de
...
\index{>@\code{>} (Bash)|bfhyperpage}«\code{>}» permet, lui, de rediriger la
sortie d'un programme vers un fichier afin de sauvegarder les
résultats. Enfin, l'opérateur de redirection %
