...
d'un vecteur; on dit qu'on leur attribue une \emph{étiquette}. Le
résultat est un \Index{vecteur!étiqueté}\emph{vecteur étiqueté}, ou
\Index{vecteur!nommé}\emph{vecteur nommé}. Il y a
