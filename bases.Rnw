...
Les \capsule{matrices et tableaux} ne sont rien d'autre que des
vecteurs dotés d'un attribut \attribut{dim}. Ces objets sont donc
stockés, et peuvent être manipulés, exactement comme des vecteurs
simples.
