...
\item[\Icode{paste}] \index{chaine de caratères!concaténation}
...
@
\item[\Icode{nchar}] \index{chaine de caratères!nombre de caractères}
  nombre de caractères dans une chaine de caractères
<<echo=TRUE>>=
nchar(c("foo", "foobar"))
@
\item[\Icode{substr}] \index{chaine de caratères!sous-chaine}
  sous-chaine (partie) d'une chaine de caractères
<<echo=TRUE>>=
substr("abcdef", 2, 4)
@
\item[\Icode{strsplit}] \index{chaine de caratères!séparation}
