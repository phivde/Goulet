...
conditionnelles sont les premières structures de contrôle du flux d'un
programme que nous étudierons. Les boucles itératives feront l'objet
de la \autoref{sec:tri:boucles}.
