...
\end{Verbatim}
  ...
  Pour clarifier la \index{semantique@sémantique}sémantique des
  nombres magiques et pour éviter du même coup les périls de la
  répétition, affectez les constantes à des variables --- portant des
  noms significatifs! --- puis utilisez ces variables dans les
  opérations arithmétiques. Par convention, vous devriez écrire les
