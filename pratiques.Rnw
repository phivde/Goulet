...
\begin{exercice}[nosol]
  ...
  valeur \code{4} dans le champ \code{Tab width} (voir la
...
\begin{exercice}
  ...
  \begin{enumerate}[1.]
  \item la fonction prend en argument une série de nombres réels
    positifs, négatifs ou nuls sous forme de vecteur;
