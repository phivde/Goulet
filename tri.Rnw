...
Or, pour citer \citet{Kernighan:practice:1999}:
\begin{quote}
...
plusieurs personnes trient sans que ce ne soit nécessaire; ou bien que
...
Pour vous convaincre de la variété d'algorithmes de tri, prenez le
...
Si vous lisez cette phrase sans avoir complété l'expérience, je vous
...
\item tri par sélection, où la plus petite carte est identifiée et
  placée au début de la main, puis la seconde plus petite, et ainsi de
  suite;
...
\item tri paresseux, qui consiste à ne pas faire l'expérience
  recommandée.
\end{enumerate}
La \autoref{fig:tri:cartes} propose des illustrations pour les quatre
premières méthodes de tri ci-dessus.

\begin{figure}
  %% proportion des cartes (L:H) = 1:1.25
  \setlength{\unitlength}{12pt}
  \savebox{\kingc}{\usymH{1F0CE}{3\unitlength}}
  \savebox{\damec}{\usymH{1F0CD}{3\unitlength}}
  \savebox{\huitc}{\usymH{1F0C8}{3\unitlength}}
  \savebox{\septc}{\usymH{1F0C7}{3\unitlength}}
  \savebox{\quatc}{\usymH{1F0C4}{3\unitlength}}
  \savebox{\handl}{\color{orange}\smaller[2]\faAngleLeft}
  \savebox{\handr}{\color{orange}\smaller[2]\faAngleRight}
  \savebox{\handu}{\color{orange}\smaller[2]\faAngleUp}
  \savebox{\handsep}{%
    \begin{picture}(0.075,1.5)
      \put(0,0){\color{orange}\rule{0.075\unitlength}{1.5\unitlength}}
    \end{picture}%
  }
  ...
  \begin{minipage}[t]{0.45\linewidth}
    \centering\mbox{} \\
    %% tri par insertion
    \begin{picture}(12.5\unitlength,19\unitlength)
      \put( 0.0,16){\usebox{\damec}}\put(2.48,17.5){\makebox(0,0){\usebox{\handsep}}}
      \put( 2.6,16){\usebox{\septc}}\put(3.8,15.7){\makebox(0,0){\usebox{\handl}}}
      \put( 5.2,16){\usebox{\quatc}}
      \put( 7.8,16){\usebox{\kingc}}
      \put(10.4,16){\usebox{\huitc}}

      \put( 0.0,12){\usebox{\septc}}
      \put( 2.6,12){\usebox{\damec}}\put(5.08,13.5){\makebox(0,0){\usebox{\handsep}}}
      \put( 5.2,12){\usebox{\quatc}}\put(6.4,11.7){\makebox(0,0){\usebox{\handl}\usebox{\handl}}}
      \put( 7.8,12){\usebox{\kingc}}
      \put(10.4,12){\usebox{\huitc}}

      \put( 0.0,8){\usebox{\quatc}}
      \put( 2.6,8){\usebox{\septc}}
      \put( 5.2,8){\usebox{\damec}}\put(7.68,9.5){\makebox(0,0){\usebox{\handsep}}}
      \put( 7.8,8){\usebox{\kingc}}\put(9.0,7.7){\makebox(0,0){\usebox{\handl}\usebox{\handr}}}
      \put(10.4,8){\usebox{\huitc}}

      \put( 0.0,4){\usebox{\quatc}}
      \put( 2.6,4){\usebox{\septc}}
      \put( 5.2,4){\usebox{\damec}}
      \put( 7.8,4){\usebox{\kingc}}\put(10.28,5.5){\makebox(0,0){\usebox{\handsep}}}
      \put(10.4,4){\usebox{\huitc}}\put(11.6,3.7){\makebox(0,0){\usebox{\handl}\usebox{\handl}}}

      \put( 0.0,0){\usebox{\quatc}}
      \put( 2.6,0){\usebox{\septc}}
      \put( 5.2,0){\usebox{\huitc}}
      \put( 7.8,0){\usebox{\damec}}
      \put(10.4,0){\usebox{\kingc}}\put(12.88,1.5){\makebox(0,0){\usebox{\handsep}}}
    \end{picture}
    \subcaption{Tri par insertion}
    \vspace{\baselineskip}
    %% tri par sélection
    \begin{picture}(12.5\unitlength,19\unitlength)
      \put(-0.12,17.5){\makebox(0,0){\usebox{\handsep}}}
      \put( 0.0,16){\usebox{\damec}}
      \put( 2.6,16){\usebox{\septc}}
      \put( 5.2,16){\usebox{\quatc}}\put(6.4,15.7){\makebox(0,0){\usebox{\handu}}}
      \put( 7.8,16){\usebox{\kingc}}
      \put(10.4,16){\usebox{\huitc}}

      \put( 0.0,12){\usebox{\quatc}}\put(2.48,13.5){\makebox(0,0){\usebox{\handsep}}}
      \put( 2.6,12){\usebox{\damec}}
      \put( 5.2,12){\usebox{\septc}}\put(6.4,11.7){\makebox(0,0){\usebox{\handu}}}
      \put( 7.8,12){\usebox{\kingc}}
      \put(10.4,12){\usebox{\huitc}}

      \put( 0.0,8){\usebox{\quatc}}
      \put( 2.6,8){\usebox{\septc}}\put(5.08,9.5){\makebox(0,0){\usebox{\handsep}}}
      \put( 5.2,8){\usebox{\damec}}
      \put( 7.8,8){\usebox{\kingc}}
      \put(10.4,8){\usebox{\huitc}}\put(11.6,7.7){\makebox(0,0){\usebox{\handu}}}

      \put( 0.0,4){\usebox{\quatc}}
      \put( 2.6,4){\usebox{\septc}}
      \put( 5.2,4){\usebox{\huitc}}\put(7.68,5.5){\makebox(0,0){\usebox{\handsep}}}
      \put( 7.8,4){\usebox{\damec}}\put(9.0,3.7){\makebox(0,0){\usebox{\handu}}}
      \put(10.4,4){\usebox{\kingc}}
      ...
      \put(10.4,0){\usebox{\kingc}}\put(12.88,1.5){\makebox(0,0){\usebox{\handsep}}}
    \end{picture}
    \setcounter{subfigure}{2} % 3e graphique sur la page
    \subcaption{Tri par sélection}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.45\linewidth}
    \centering\mbox{} \\
    %% tri par échange
    \begin{picture}(12.5\unitlength,23\unitlength)
      \put(-0.12,21.5){\makebox(0,0){\usebox{\handsep}}}
      \put( 0.0,20){\usebox{\damec}}\put(1.2,19.7){\makebox(0,0){\usebox{\handr}}}
      \put( 2.6,20){\usebox{\septc}}\put(3.8,19.7){\makebox(0,0){\usebox{\handl}}}
      \put( 5.2,20){\usebox{\quatc}}
      \put( 7.8,20){\usebox{\kingc}}
      \put(10.4,20){\usebox{\huitc}}

      \put( 0.0,16){\usebox{\septc}}
      \put( 2.6,16){\usebox{\damec}}\put(3.8,15.7){\makebox(0,0){\usebox{\handr}}}
      \put( 5.2,16){\usebox{\quatc}}\put(6.4,15.7){\makebox(0,0){\usebox{\handl}}}
      \put( 7.8,16){\usebox{\kingc}}
      \put(10.4,16){\usebox{\huitc}}

      \put( 0.0,12){\usebox{\septc}}\put(1.2,11.7){\makebox(0,0){\usebox{\handr}}}
      \put( 2.6,12){\usebox{\quatc}}\put(3.8,11.7){\makebox(0,0){\usebox{\handl}}}
      \put( 5.2,12){\usebox{\damec}}
      \put( 7.8,12){\usebox{\kingc}}
      \put(10.4,12){\usebox{\huitc}}
      ...
      \put( 2.6,8){\usebox{\septc}}
      \put( 5.2,8){\usebox{\damec}}
      \put( 7.8,8){\usebox{\kingc}}\put( 9.0,7.7){\makebox(0,0){\usebox{\handr}}}
      \put(10.4,8){\usebox{\huitc}}\put(11.6,7.7){\makebox(0,0){\usebox{\handl}}}

      \put( 0.0,4){\usebox{\quatc}}
      \put( 2.6,4){\usebox{\septc}}
      \put( 5.2,4){\usebox{\damec}}\put(6.4,3.7){\makebox(0,0){\usebox{\handr}}}
      \put( 7.8,4){\usebox{\huitc}}\put(9.0,3.7){\makebox(0,0){\usebox{\handl}}}
      \put(10.4,4){\usebox{\kingc}}
      ...
      \put(10.4,0){\usebox{\kingc}}\put(12.88,1.5){\makebox(0,0){\usebox{\handsep}}}
    \end{picture}
    \setcounter{subfigure}{1} % 2e graphique sur la page
    \subcaption{Tri par échange}
    \vspace{\baselineskip}
    \begin{picture}(12.5\unitlength,10.5\unitlength)
      \put(-0.12,9.0){\makebox(0,0){\usebox{\handsep}}}
      \put( 0.0,7.5){\usebox{\damec}}
      \put( 2.6,7.5){\usebox{\septc}}
      \put( 5.2,7.5){\usebox{\quatc}}
      \put( 7.8,7.5){\usebox{\kingc}}
      \put(10.4,7.5){\usebox{\huitc}}

      \put( 1.2,6.5){\makebox(0,0.5){\smaller $3$}}
      \put( 3.8,6.5){\makebox(0,0.5){\smaller $1$}}
      \put( 6.4,6.5){\makebox(0,0.5){\smaller $0$}}
      \put( 9.0,6.5){\makebox(0,0.5){\smaller $4$}}
      \put(11.6,6.5){\makebox(0,0.5){\smaller $2$}}

      \thicklines\color{orange}
      \Vector( 1.2,6)( 8.9,3.5)
      \Vector( 3.8,6)( 3.8,3.5)
      \Vector( 6.4,6)( 1.3,3.5)
      \Vector( 9.0,6)(11.4,3.5)
      \Vector(11.6,6)( 6.5,3.5)
      ...
      \put(10.4,0){\usebox{\kingc}}\put(12.88,1.5){\makebox(0,0){\usebox{\handsep}}}
    \end{picture}
    \setcounter{subfigure}{3} % 4e graphique sur la page
    \subcaption{Tri par dénombrement}
  \end{minipage}
  \caption{Illustrations de quatre méthodes de tri pour une main de
    cinq cartes à jouer. Les lignes verticales délimitent les cartes
    triées de celles qui ne le sont pas. Les symboles
    «{\smaller\faAngleLeft}» et «{\smaller\faAngleRight}» indiquent le
    sens et le nombre de déplacements à effectuer. Le symbole
    «{\smaller\faAngleUp}» identifie la plus faible parmi les cartes
    non triées.}
  \label{fig:tri:cartes}
\end{figure}

Ce chapitre est consacré à l'étude des algorithmes classiques de tri
et de recherche. Ces opérations sont par nature répétitives. Le sujet
se prête donc aussi tout naturellement à la conception de boucles
itératives dans R.


\section{Définition du problème et notation}
\label{sec:tri:notation}

Avant d'aller plus loin, prenons le temps de définir formellement le
problème de tri et de nous munir de la notation qui sera utilisée tout
au long du chapitre. Nous allons tâcher de trier $n$
\emph{enregistrements}
\begin{equation*}
  E_1, E_2, \dots, E_n.
\end{equation*}
Un enregistrement est un ensemble d'informations formant un tout
logique et qui sont manipulées en bloc. Lorsque ce sera nécessaire,
l'ensemble des enregistrements sera nommé \emph{fichier}. À chaque
enregistrement $E_j$ correspond une \emph{clé} de tri $C_j$.

Par exemple, dans le fichier des résultats d'un cours universitaire,
un enregistrement correspond aux résultats d'un étudiant ou d'une
étudiante. Il est généralement formé d'un numéro d'identification
unique, du nom, du prénom et des résultats de toutes les évaluations.
Chacun de ces éléments peut constituer une clé de tri, afin de classer
la liste par numéro d'identification, par nom, par résultat à une
évaluation donnée, etc.

\tipbox{Vous avez déjà rencontré ce genre d'interface dans une page
  web: des données présentées sous forme de tableau avec la
  possibilité de cliquer sur un titre de colonne pour trier les
  données selon celle-ci. Chaque ligne du tableau constitue un
  enregistrement et chaque colonne constitue une éventuelle clé de
  tri.}

Sans perte de généralité, nous allons étudier le tri en ordre
croissant. Le problème consiste donc à trouver une permutation
$\{(1), (2), \dots, (n)\}$ des indices $\{1, 2, \dots, n\}$ qui
ordonne les clés de telle sorte que
\begin{equation*}
...
\label{sec:tri:insertion}

Le tri par insertion est l'une des techniques de tri les plus simples
et intuitives. C'est probablement celle que vous avez utilisée lors de
la petite expérience du début du chapitre. Elle consiste à examiner
les enregistrements tour à tour à partir du deuxième et, pour chacun,
à trouver sa position dans les enregistrements déjà triés qui le
précèdent. En d'autres termes, lors de l'examen de l'enregistrement
$E_j$, $j \geq 2$, les enregistrements $E_1, \dots, E_{j - 1}$ sont
déjà triés et il s'agit de trouver la position de $E_j$ parmi ceux-ci.

Dans la suite, nous allons illustrer les algorithmes en triant le
vecteur de 16 nombres entiers suivant:

<<script, results=hide>>=
set.seed(4)
x <- sample(sample(10:900, 16))
xf <- sprintf("%03d", x)
@

\begin{gather*}
<<echo=FALSE, results = tex>>=
cat(paste(paste(xf[1:8], collapse = "\\quad "), "\\\\ ",
          paste(xf[9:16], collapse = "\\quad ")))
@
\end{gather*}

\begin{algorithme}[Tri par insertion]
  \label{algo:tri:insertion}
  Réorganiser les enregistrements $E_1, \dots, E_n$ de telle sorte
  qu'en sortie leurs clés soient en ordre croissant,
  $C_{1} \leq \cdots \leq C_{n}$.
  \begin{enumerate}
  \item Répéter les étapes 2 à 5 pour $j = 2, 3, \dots, n$, puis
    terminer l'algorithme. [Trier les enregistrements un à un, sauf le
    premier.]
  \item Poser $i \leftarrow j - 1$, $C \leftarrow C_j$, $E \leftarrow
    E_j$. [Les étapes suivantes permettront de déterminer
    l'emplacement de l'enregistrement $E$ en comparant sa clé $C$ avec
    les clés $C_i$ des enregistrements déjà triés, et ce, en ordre
    décroissant de $i$.]
  \item Si $C \geq C_i$, aller à l'étape~5. [La position de
    l'enregistrement est trouvée.]
  \item Poser $E_{i + 1} \leftarrow E_i$, puis $i \leftarrow i - 1$.
    Si $i > 0$, retourner à l'étape~3. [Déplacer l'enregistrement
    $E_i$, puis s'apprêter à reprendre la comparaison avec
    l'enregistrement trié précédent. Si $i = 0$, $C$ est la plus
    petite clé et la position de l'enregistrement est au début du
    fichier.]
  \item Poser $E_{i + 1} \leftarrow E$. [Placer l'enregistrement à sa
    position.]
  \end{enumerate}
\end{algorithme}
...
\item \meta{expression} est le contenu de la boucle à proprement
  ...
  \meta{expression}. Comme toujours, si le contenu est constitué de
...
\item \meta{expression} est l'expression ou le groupe d'expressions à
  ...
  indéfiniment, \meta{expression} est toujours un groupe
...
\begin{exercice}
  ...
  La fonction \icode{scan} utilisée avec l'argument \code{what =
