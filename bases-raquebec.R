...
## [[[ Matériel avancé
## Nous pourrions faire encore plus élégant en permettant que
## les arguments 'fa' et 'fb' soient des expressions R qui
## seront évaluées dans la fonction.
f <- function(x, y, fa, fb)
{
    g <- function(a, b)
        x * a^2 + y * b + a * b
    g(eval(substitute(fa)), eval(substitute(fb)))
}
f(2, 3, 1 + x * y, 1 - y)
## ]]]
