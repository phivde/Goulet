...
caractéristiques de plusieurs lois de probabilité dans S-Plus et
\textsf{R}. Pour chaque racine \code{\textit{loi}}, il existe quatre
...
\textsf{R}, leur racine et le nom de leurs paramètres sont rassemblés
