...
On reprend ici l'idée de la \autoref{presentation:session}, mais en
présentant cette fois les étapes d'une %
\capsule{http://youtu.be/xiNnHegDau8}{session de travail avec Emacs et
  le mode ESS}.
...
\begin{itemize}
\item On modifie le comportement et l'apparence de l'éditeur par le
  biais de commandes réunies dans un %
  \capsule{http://youtu.be/IsyQn7d2Ao0}{fichier de configuration} %
