...
\begin{figure}[t]
  \begin{framed}
    ...
    \begin{minipage}[t]{0.85\linewidth}
      ...
      et laisser la touche \code{Option} (\optkey) jouer son rôle
      usuel, il suffit d'insérer les lignes suivantes dans son fichier
      de configuration \code{.emacs} (voir la
