...
le Syndrôme de la plaque à biscuits{\texttrademark}.

Le petit manège décrit ci-dessus se reproduit à l'identique dans la
...
Dans les exemples du \autoref{fonctions}, nous composeront des
...
\begin{exercice}
  ...
  \begin{equation*}
    \frac{n}{\dfrac{1}{x_1} + \dots + \frac{1}{x_n}}.
  \end{equation*}
...
\begin{exercice}
  ...
  de paiements définie à l'\autoref{exercice:exemples:serie} en supposant que le
