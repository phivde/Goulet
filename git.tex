...
{%
  ...
  vers la \link{https://git-scm.com/book/fr/v2}{version en ligne}.
}
\medskip
...
Pour une information plus approfondie sur la manière dont Git stocke ses données et comment récupérer des données qui pourraient sembler perdues, référez-vous à la \link{https://git-scm.com/book/fr/v2/Les-bases-de-Git-Annuler-des-actions#s_undoing}{Annuler des actions}.
