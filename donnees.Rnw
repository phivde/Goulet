...
\notebox{Les exemples ci-dessus utilisent la date du 29 février 2000.
  Que s'est-il passé de spécial ce jour-là? Les années multiples de
  100 ne sont pas bissextiles, sauf celles multiples de 400. C'est
