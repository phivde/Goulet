...
\begin{figure}[t]
  ...
  \begin{minipage}{0.45\linewidth}
    ...
    \end{picture}
  \end{minipage}
  \caption[Représentations schématiques de tableaux à trois et à
  quatre dimensions]{%
    Représentations schématiques d'une matrice (en haut à gauche),
    d'un tableau à trois dimensions (en bas à gauche) et d'un tableau
    à quatre dimensions (à droite). Les chiffres encerclés identifient
    l'ordre de remplissage des dimensions.}
...
\begin{figure}
  ...
  \begin{minipage}{0.22\linewidth}
    ...
    \end{picture}
  \end{minipage}
  \caption[Représentations schématiques d'opérations d'indiçage sur
  une matrice]{%
    Représentations schématiques d'opérations d'indiçage sur une
    matrice. De gauche à droite: matrice complète; sélection d'une
    ligne; sélection d'une colonne; sélection d'un élément unique.}
...
\begin{figure}
  ...
  \begin{minipage}{0.22\linewidth}
    ...
    \end{picture}
  \end{minipage}
  \caption[Représentations schématiques d'opérations d'indiçage sur un
  tableau à trois dimensions]{%
    Représentations schématiques d'opérations d'indiçage sur un
    tableau à trois dimensions. De gauche à droite: tableau
    complet; sélection d'une tranche horizontale; sélection d'une carotte
    transversale; sélection d'un élément unique.}
...
La \autoref{fig:donnees:application:matrice} propose une
représentation schématique des opérations d'applications sur les
lignes et les colonnes d'une matrice.
...
\begin{figure}
  ...
  \begin{tabularx}{\linewidth}{cXcXc}
    ...
    \end{picture}
  \end{tabularx}
  \caption{Représentations schématiques des opérations d'application
    sur une matrice}
...
\begin{figure}
  ...
  \begin{tabularx}{\linewidth}{cXcXc}
    ...
    \end{picture}
  \end{tabularx}
  \caption{Représentations schématiques d'opérations d'application
    sur un tableau}
...
\begin{figure}
  ...
  \end{picture}
  \caption[Représentation schématique d'une liste]{%
    Représentation schématique d'une liste composée d'un vecteur
    numérique, d'un vecteur caractère et d'un vecteur booléen}
...
\begin{figure}
  ...
  \begin{minipage}[t]{0.4\linewidth}
    ...
    \end{picture}
  \end{minipage}
  \caption{Représentation schématique des opérations d'indiçage d'une
    liste}
...
La \autoref{fig:donnees:application:lapply+sapply} illustre
schématiquement l'effet respectif des fonctions d'application
\code{lapply} et \code{sapply} sur une liste.
...
\begin{figure}
  ...
  \begin{tabularx}{0.92\linewidth}{cXc}
    ...
    \end{picture}
  \end{tabularx}
  \caption{Représentation schématique des fonctions d'application
...
\begin{figure}
  ...
  \begin{tabularx}{0.8\linewidth}{cXcXc}
    ...
    \end{picture}
  \end{tabularx}
  \caption{Représentation schématique de la fonction d'application
    \code{mapply}}
