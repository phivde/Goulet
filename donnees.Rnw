...
\begin{figure}[t]
  ...
  \begin{minipage}[b]{0.45\linewidth}
    ...
    \end{picture}
  \end{minipage}
  \caption[Représentation schématique de tableaux à trois et à quatre
  dimensions]{%
    Représentation schématique de tableaux à trois dimensions (gauche)
...
\begin{figure}
  ...
  \caption{Représentations schématiques d'opérations d'indiçage sur
    une matrice: sélection d'une ligne, d'une colonne et d'un élément
    unique}
...
\begin{figure}
  ...
  \end{minipage}
  \caption{Représentations schématiques d'opérations d'indiçage sur
    un tableau à trois dimensions: sélection d'une tranche
    horizontale, d'une carotte transversale et d'un élément unique}
