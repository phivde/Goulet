...
\begin{figure}
  ...
  \caption[Représentation d'une liste]{%
    ...
    vecteur caractère et d'un vecteur booléen}
...
\warningbox{Évitez d'effectuer des calculs avec les codes des
  ...
  Vous devez d'abord récupérer les valeurs numériques correspondant
  aux codes du facteur à l'aide de la recette recommandée dans la
