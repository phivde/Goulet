...
\begin{figure}[t]
  ...
  \begin{minipage}[b]{0.4\linewidth}
    ...
    \savebox{\plainmat}(5,4)[bl]{
      \thicklines
      \roundjoin
      \color{white}
      \polygon*(0,0)(0,4)(5,4)(5,0)
      \color{black}
      \moveto(0,0)
      \lineto(0,4) \lineto(5,4) \lineto(5,0)
      \closepath
      \strokepath
    }
    \begin{picture}(9,7)
      \multiput(3,3)(-1,-1){4}{\usebox{\plainmat}}
      \put(0.75,3.5){\circle{0.7}}\put(0.76,3.51){\makebox(0,0){\footnotesize 1}}
      \put(0.75,3){\vector(0,-1){2.5}}
      \put(1.75,3.5){\circle{0.7}}\put(1.76,3.51){\makebox(0,0){\footnotesize 2}}
      \put(2.25,3.5){\vector(1,0){2.5}}
  ...
  \begin{minipage}[b]{0.45\linewidth}
    %% redéfinition de \plainnat avec une nouvelle \unitlength
    ...
    \begin{picture}(14,12)
      \multiput(9,8)(-1,-1){4}{\usebox{\plainmat}}
      \multiput(3,3)(-1,-1){4}{\usebox{\plainmat}}
      \put(0.9,3.4){\circle{0.8}}\put(0.91,3.41){\makebox(0,0){\scriptsize 1}}
      \put(0.9,2.8){\vector(0,-1){2.4}}
      \put(1.9,3.4){\circle{0.8}}\put(1.91,3.41){\makebox(0,0){\scriptsize 2}}
      \put(2.60,3.4){\vector(1,0){2.20}}
      \put(6.4,0.3){\circle{0.8}}\put(6.41,0.31){\makebox(0,0){\scriptsize 3}}
      \put(6.8,0.7){\vector(1,1){1.3}}
      \put(7.6,0.3){\circle{0.8}}\put(7.61,0.31){\makebox(0,0){\scriptsize 4}}
      \put(8.0,0.7){\vector(1,1){6.3}}
    \end{picture}
  \end{minipage}
  \caption[Représentations schématiques de tableaux à trois et à quatre
  dimensions]{%
    Représentations schématiques de tableaux à trois dimensions (gauche)
    et à quatre dimensions (droite). Les chiffres encerclés
...
\begin{figure}
  ...
  \begin{minipage}{0.22\linewidth}
    ...
    \begin{picture}(5,3.5)
      ...
      \multiput(0.0,2.0)(1,0){5}{\usebox{\ccarre}}
    \end{picture}
  \end{minipage}
  \hfill
  \begin{minipage}{0.22\linewidth}
    ...
    \begin{picture}(5,3.5)
      %% indiçage colonne 3
      \put(0.0,0.0){\usebox{\matrice}}
      \multiput(2.0,0.0)(0,1){3}{\usebox{\ccarre}}
    \end{picture}
  \end{minipage}
  \hfill
  \begin{minipage}{0.22\linewidth}
...
\begin{figure}
  ...
  \begin{minipage}{0.22\linewidth}
    ...
    \begin{picture}(7,4.7)
      ...
      \put(0.0,0.0){\usebox{\tableau}}
      \multiput(1.5,2.9)(1,0){5}{\usebox{\ccube}}
      \multiput(1.0,2.6)(1,0){5}{\usebox{\ccube}}
      \multiput(0.5,2.3)(1,0){5}{\usebox{\ccube}}
      \multiput(0.0,2.0)(1,0){5}{\usebox{\ccube}}
    \end{picture}
  \end{minipage}
  \hfill
  \begin{minipage}{0.22\linewidth}
...
\index{carotte}carottes tirées de \code{X} (des vecteurs).
