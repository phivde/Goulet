...
Cette annexe explique comment \capsule{configurer R} pour faciliter
...
préciser le site miroir de CRAN lors de l'\capsule{installation de
  packages}. Ainsi, la simple commande
\begin{Schunk}
\begin{Sinput}
