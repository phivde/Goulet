\documentclass[letterpaper,11pt]{memoir}
  ...
  \usepackage{textcomp,graphicx,color}
  ...
  %%% Commande pour le nom du langage R
  \newcommand{\R}{\textsf{R}}
  ...
  %%% Modification des environnements de Sweave
  ...
  %%% Environnements pour les exercices et réponses. On utilise
  %%% \thechapter plutôt que \arabic{chapter} pour la numérotation des
  ...
  \includeonly{presentation,ess}

\begin{document}

%% Redéfinition de la puce dans les listes. Doit être fait ici à cause
%% de babel. Le symbole provient de MnSymbol.
\renewcommand{\FrenchLabelItem}{$\filledtriangleright$}
