...
\begin{frame}
  ...
  \item `\code{...}': arguments supplémentaires, séparés par des
    virgules, à passer à \code{FUN}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
  \item \Fonction{lapply} et \Fonction{sapply} appliquent
    une fonction aux éléments d'un vecteur ou d'une liste
...
\begin{frame}
  ...
  \begin{itemize}
  \item \fonction{lapply} applique \code{FUN} à tous les éléments d'un
    vecteur ou d'une liste \code{X} et retourne le résultat sous forme
    de liste
