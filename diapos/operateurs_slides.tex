...
%\subsubsection{Manipulation de vecteurs}
...
%\subsubsection{Recherche d'éléments dans un vecteur}
...
%\subsubsection{Sommaires et statistiques descriptives}
...
\begin{frame}
  ...
  \item[\Fonction{sum}, \Fonction{prod}] somme\index{somme} et
    produit\index{produit} des éléments
  ...
  \item[\Fonction{var}, \Fonction{sd}] variance\index{variance} et
    écart type\index{ecart type@écart type} (sans biais)
...
%\subsubsection{Sommaires cumulatifs et comparaisons élément par élément}
...
%\subsubsection{Produit extérieur}
...
\begin{frame}
  \begin{block}{\code{ifelse(\emph{condition}, \emph{expression.vrai},
