...
\subsection{Calcul de valeurs présentes}
...
\begin{frame}
  ...
  \begin{block}{Énoncé}
    ...
    dans un an. Trouver le montant du prêt pour\dots
    \begin{enumerate}[a)]
...
\begin{frame}
  \frametitle{Solution}
  Formule générale pour la valeur présente d'une série de paiements
  $P_1, P_2, \dots, P_n$ à la fin des années $1, 2, \dots, n$:
  \begin{displaymath}
...
\subsection{Fonctions de probabilité}
\label{exemples:fp}
...
\subsection{Fonction de répartition de la loi gamma}

\begin{frame}
  \frametitle{Fonction de répartition de la loi gamma}

  Nous utilisons la paramétrisation où la fonction de densité de
  probabilité est
  \begin{displaymath}
