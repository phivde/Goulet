...
\begin{adjustwidth*}{\unitlength}{-\unitlength}
  ...
  \begin{tabularx}{1.0\linewidth}{@{}Xl@{}}
    Code informatique des sections d'exemples & \href{https://github.com/vigou3/introduction-programmation-r/releases/download/\ednum-edition/introduction-programmation-r-exemples.zip}{\downloadbutton} \\
    \addlinespace[3pt]
