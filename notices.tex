...
\begin{adjustwidth*}{\unitlength}{-\unitlength}
  ...
  \raisebox{-2.5mm}{\includegraphics[height=7mm,keepaspectratio=true]{images/by-nc-sa}} %
  {\theauthor}, {\year}
  ...
  dérivées de «Pro Git» de Scott Chacon et Ben Straub sous licence
  \href{https://creativecommons.org/licenses/by-nc-sa/3.0/deed.fr}{%
    Attribution-Pas d’utilisation commerciale-Partage dans les mêmes
    conditions 3.0 non transposé} de Creative Commons. Cette licence
  ne permet pas d'adapter l'œuvre pour une utilisation commerciale et
  elle ajoute aux conditions ci-dessus: \par
  \begin{tabularx}{\linewidth}{@{}lX@{}}
    \raisebox{-9mm}[0mm][13mm]{\includegraphics[height=11mm,keepaspectratio=true]{images/nc}}
  ...
  \textbf{Crédits} \\
  Image de peintre créée par \href{iconicbestiary/Freepik}{https://www.freepik.com}.
\end{adjustwidth*}
\endgroup
