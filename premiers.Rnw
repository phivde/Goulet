...
<<echo=FALSE>>=
## configuration pour Sweave et définition des fonctions
## 'getSourceName' et 'renameTangled'
source(".Sweaveprofile")
                           #
## nom du présent fichier
file <- getSourceName()
...
\gotorbox{La présente section est très importante pour la suite.
  ...
  lignes \reflines{premiers:vecteurs} du fichier de script
...
\label{sec:premiers:internes:math}
