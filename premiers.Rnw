...
\gotorbox{Étudier et exécuter les lignes
  \reflines{bases:fondamentales} du code informatique de la
...
\label{sec:premiers:fonctions:paradigme}
...
\label{sec:premiers:fonctions:definition}
...
@
  ...
  meilleur exemple à la \autoref{sec:premiers:exemples} que ce que nous
...
\label{sec:premiers:fonctions:appel}
...
\label{sec:premiers:fonctions:resultats}
